...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'fileDesc'); ?>
		<?php echo $form->textField($model,'fileDesc',array('size'=>60,'maxlength'=>255)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'classify'); ?>
		<?php echo $form->textField($model,'classify',array('size'=>60,'maxlength'=>255)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'covered'); ?>
		<?php echo $form->textField($model,'covered'); ?>
	</div>
